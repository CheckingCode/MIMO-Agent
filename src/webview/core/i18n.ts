...
const translations: Record<Lang, Record<string, string>> = {
    ...
    zh: {
        ...
        'reasoning.deep': '深入',
        'reasoning.max': '极限',
        'reasoning.turbo.tip': '推理能力：极速。关闭额外 thinking，显著降低 token 和工具轮次预算，适合简单问答。',
        'reasoning.fast.tip': '推理能力：快速。关闭额外 thinking，降低 token 和工具轮次预算，适合小改动。',
        'reasoning.balanced.tip': '推理能力：均衡。使用模型默认 thinking 策略和标准预算，适合多数任务。',
        'reasoning.deep.tip': '推理能力：深入。启用 thinking，提高 token 和工具轮次预算，适合复杂任务。',
        'reasoning.max.tip': '推理能力：极限。启用 thinking，大幅提高 token 和工具轮次预算，适合长链路难任务。',
        'open.editor': '在编辑器中打开',
